...
func _ready():                                                                                          #When it spawns in
	add_to_group("YELLOWS")                                                                                #Adds to group "REDS"
...
func _draw():                                                                                           #Overrides original draw func
	draw_circle(Vector2(0, 0), globals.RADIUS, Color(1, 1, 0, 0.75))                                          #Draws the dot
...
func _physics_process(_delta):
	...
	for a in REDS.size():
		...
		if RED != self:
			...
			if dis1.y < dis.y:
				...
				dis.y = dis2.y
			var COLOURTOCOLOURVALUE = ATTRACTIONCALCULATOR.GETATTRACTION(5, 0)
	...
	for a in BLUES.size():
		...
		if dis1.y < dis.y:
			...
			dis.y = dis2.y
		var COLOURTOCOLOURVALUE = ATTRACTIONCALCULATOR.GETATTRACTION(5, 1)
		var ATTRACTIONTOTAL = MOVES.GETATTRACTION(dis, COLOURTOCOLOURVALUE)
		VELOCITY += ATTRACTIONTOTAL * globals.SENSITIVITY
		BLUES.pop_at(0)
	...
	for a in GREENS.size():
		...
		if dis1.y < dis.y:
			...
			dis.y = dis2.y
		var COLOURTOCOLOURVALUE = ATTRACTIONCALCULATOR.GETATTRACTION(5, 2)
		var ATTRACTIONTOTAL = MOVES.GETATTRACTION(dis, COLOURTOCOLOURVALUE)
		VELOCITY += ATTRACTIONTOTAL * globals.SENSITIVITY
		GREENS.pop_at(0)
	...
	for a in ORANGES.size():
		...
		if dis1.y < dis.y:
			...
			dis.y = dis2.y
		var COLOURTOCOLOURVALUE = ATTRACTIONCALCULATOR.GETATTRACTION(5, 3)
		var ATTRACTIONTOTAL = MOVES.GETATTRACTION(dis, COLOURTOCOLOURVALUE)
	...
	for a in PURPLES.size():
		...
		if dis1.y < dis.y:
			...
			dis.y = dis2.y
		var COLOURTOCOLOURVALUE = ATTRACTIONCALCULATOR.GETATTRACTION(5, 4)
		var ATTRACTIONTOTAL = MOVES.GETATTRACTION(dis, COLOURTOCOLOURVALUE)
		linear_velocity += ATTRACTIONTOTAL * globals.SENSITIVITY
		PURPLES.pop_at(0)
	...
	for a in YELLOWS.size():
		...
		if YELLOW != self:
			...
			if dis1.y < dis.y:
				...
				dis.y = dis2.y
			var COLOURTOCOLOURVALUE = ATTRACTIONCALCULATOR.GETATTRACTION(5, 5)
			var ATTRACTIONTOTAL = MOVES.GETATTRACTION(dis, COLOURTOCOLOURVALUE)
			linear_velocity += ATTRACTIONTOTAL * globals.SENSITIVITY
		YELLOWS.pop_at(0)
